...
const mesalbum  = [
    {
        ...
        songs: [
            ...
            },
            {
                ...
                lyrics: [
                    {alph: [
                            {line: 'Did a full 180, crazy'},
                            {line: 'Thinking bout the way I was'},
                            {line: 'Did the heartbreak change me? Maybe'},
                            {line: 'But look at where I ended up'},
                            {line: 'Im all good already'},
                            {line: 'So moved on, its scary'},
                            {line: 'Im not where you left me at all, so'},
                            {line: 'If you dont wanna see me dancing with somebody'},
                            {line: 'If you wanna believe that anything could stop me'},
                            {line: 'Dont show up, dont come out'},
                            {line: 'Dont start caring about me now'},
                            {line: 'Walk away, you know how'},
                            {line: 'Dont start caring about me now'},
                            {line: 'Arent you the guy who tried to'},
                            {line: 'Hurt me with the word "goodbye"?'},
                            {line: 'Though it took some time to survive you'},
                            {line: 'Im better on the other side'},
                            {line: 'Im all good already'},
                            {line: 'So moved on, its scary'},
                            {line: 'Im not where you left me at all, so'},
                            {line: 'If you dont wanna see me dancing with somebody'},
